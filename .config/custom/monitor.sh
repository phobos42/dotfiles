...
xrandr --output HDMI-0 --left-of DP-0 --scale 1.5x1.5 --pos 0x0
fi
...
if xrandr | grep "DP-5 connected"; then
xrandr --output DP-5 --right-of DP-0 --scale 1.5x1.5 --pos 3850x540
xrandr --output DP-5 --pos 6720x540 #--output DVI-I-1 --pos 6720x540
fi




#xrandr --output DVI-D-0 --pos 3840x540 #--output DVI-I-1 --pos 6720x540
